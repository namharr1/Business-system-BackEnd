...
public interface ItemService {
	...
	List<Item> getAllItemsByCategory(Connection conn, String searchCategory) throws SQLException;
	List<Item> getAllItemsBySupplier(Connection conn, String searchSupplier) throws SQLException;
